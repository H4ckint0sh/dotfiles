...
### Tokyonight
export BLACK=0xff25273A
export WHITE=0xffb5c9ff
export RED=0xffFF6C8D
export GREEN=0xff90D05A
export BLUE=0xff6EA3FE
export YELLOW=0xffE9AD5B
export ORANGE=0xffFF9856
export MAGENTA=0xffC198FD
export GREY=0xff9AA9D9
export TRANSPARENT=0x00000000
