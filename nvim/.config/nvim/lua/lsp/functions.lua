...
function M.enable_format_on_save()
    ...
    vim.api.nvim_create_autocmd("BufWritePre", {
        callback = M.format, -- Pass the function reference instead of calling it
        group = group,
    })
...
vim.api.nvim_create_user_command("LspToggleAutoFormat", function() M.toggle_format_on_save() end, {})
