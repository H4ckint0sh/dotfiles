...
map_tele("n", "<leader>ff", "find_files", { desc = "find files" })
map_tele("n", "<leader>fW", "workdirs", {
    desc = "cwd workdirs",
    layout_config = {
        width = 0.60,
        height = 0.40,
...
map_tele("n", "<leader>g", "diagnostics", { bufnr = 0, desc = "document diagnostics [LSP]" })
map_tele("n", "<leader>G", "diagnostics", { desc = "workspace diagnostics [LSP]" })
